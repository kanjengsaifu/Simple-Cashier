 ...
 <!-- Static navbar -->
	...
	<div class="container" style="border-bottom:solid 1px #cacaca;">
		<div class="row">
			...
			<h2><p class="font_light" style="line-height:40px;">Selamat Datang <b class="font_bold"><?php echo $this->session->userdata('ses_user_nama'); ?></b> <br/>Di Aplikasi Kasir Sederhana</p></h2>
		</div>
		<br/>
		<br/>
		<br/>
