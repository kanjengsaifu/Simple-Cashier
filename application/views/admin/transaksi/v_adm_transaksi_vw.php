      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="<?php echo site_url ("c_adm_transaksi");?>">Teransaksi</a></li>
			...
			<div class="col-md-12">
				...
				<div class="row">
					<div class="col-md-9" style="margin-bottom:1.5%;">
								<form action="<?php echo site_url('c_adm_transaksi')?>" method="post">
						...
						<tbody>
						  ...
						  ?>
							 <tr>
                                ...
                                <td align="center">
                                	<button type="button" name="btn_hapus" class="btn-sm btn-link" style="color:#ec4445; text-decoration: none;" onclick="return hapus_data('<?php echo $baris->no_rensi ?>','<?php echo site_url("c_adm_transaksi/hapus/".$baris->no_rensi);?>');"><span class="glyphicon glyphicon-trash"></span> Hapus</button>
                                </td>
							  </tr>
						  <?php
							$no++;	
				...
				<a href="<?php echo site_url("c_adm_transaksi"); ?>">
