		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Detail Barang
				</div>
				<br/>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url('c_adm_barang/detail/'.md5(sha1($detail->kode_barang))); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
						 
						<fieldset disabled>
						<div class="form-group">
							<label class="col-sm-4 control-label">Kode Barang</label>
							<div class="col-sm-8">
								<input name="#" type="text" class="form-control" id="kode_barang" value="<?php echo $detail->kode_barang;?>">
							</div>
						</div>
						</fieldset>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-8">
								<input name="#" type="text" class="form-control"  id="nama_barang" value="<?php echo $detail->nama_barang; ?>" size="50" maxlength="50" placeholder="Isi Nama Barang" >
							</div>
						</div>
						</fieldset>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="txt_harga" type="text" class="form-control"  id="harga" value="<?php if($act == "0") echo $detail->harga; if($act == "1") echo set_value("txt_harga"); ?>" onKeyPress="return hanyaAngka(event, false)" size="25" maxlength="10" placeholder="Isi Harga" > 
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-4 control-label">Diskon</label>
							<div class="col-sm-8">
								<input name="txt_diskon" type="text" class="form-control"  id="diskon" value="<?php echo $detail->diskon; ?>" onKeyPress="return hanyaAngka(event, false)" size="15" maxlength="3" placeholder="Isi Diskon" > 
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-4 control-label">Stok</label>
							<div class="col-sm-8">
								<input name="txt_stok" type="text" class="form-control"  id="stok" value="<?php echo $detail->stok;?>" onKeyPress="return hanyaAngka(event, false)" size="15" maxlength="10" placeholder="Isi Stok" > 
							</div>
						</div>
						<br/>
						<div class="col-sm-8 col-sm-offset-4">
								<input type="submit" name="btn_ubah" id="btn_ubah" class="btn btn-success" value="Ubah" />
								<input type="button" name="submit" id="submit" class="btn btn-default" value="Batal" onClick="location.href='<?php echo site_url("c_adm_barang");?>'" />
						</div>
					</form>
				</div>		
			</div>
