		...
		<div class="row">
			...
			<div class="col-md-10" style="margin-bottom:50px;">
				<div class="page-header font_ku body">
					<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Entry Barang
				</div>
				<br/>
				<br/>
				...
				<div class="col-md-6 col-md-offset-2 col">
					<form action="<?php echo site_url("c_adm_barang/tambah"); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
						 
						<div class="form-group">
							<label class="col-sm-4 control-label">Nama Barang</label>
							<div class="col-sm-8">
								<input name="txt_nama_barang" type="text" class="form-control"  id="nama_barang" value="<?php echo set_value("txt_nama_barang"); ?>" size="50" maxlength="50" placeholder="Isi Nama Barang" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input name="txt_harga" type="text" class="form-control"  id="harga" value="<?php echo set_value("txt_harga"); ?>" onKeyPress="return hanyaAngka(event, false)" size="25" maxlength="10" placeholder="Isi Harga" > 
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-4 control-label">Diskon</label>
							<div class="col-sm-8">
								<input name="txt_diskon" type="text" class="form-control"  id="diskon" value="<?php echo set_value("txt_diskon"); ?>" onKeyPress="return hanyaAngka(event, false)" size="15" maxlength="3" placeholder="Isi Diskon" > 
							</div>
						</div>
                        <div class="form-group">
							<label class="col-sm-4 control-label">Stok</label>
							<div class="col-sm-8">
								<input name="txt_stok" type="text" class="form-control"  id="stok" value="<?php echo set_value("txt_stok"); ?>" onKeyPress="return hanyaAngka(event, false)" size="15" maxlength="10" placeholder="Isi Stok" > 
							</div>
						</div>
						<br/>
